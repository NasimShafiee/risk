...
if("TRUE" STREQUAL "TRUE")
  set(test_SOURCE_PREFIX /home/nasim_shafiee/catkin_ws_1/src/test)
  set(test_DEVEL_PREFIX /home/nasim_shafiee/catkin_ws_1/devel)
  set(test_INSTALL_PREFIX "")
  set(test_PREFIX ${test_DEVEL_PREFIX})
else()
  set(test_SOURCE_PREFIX "")
  set(test_DEVEL_PREFIX "")
  set(test_INSTALL_PREFIX /home/nasim_shafiee/catkin_ws_1/install)
...
if(NOT "/home/nasim_shafiee/catkin_ws_1/src/test/include " STREQUAL " ")
  set(test_INCLUDE_DIRS "")
  set(_include_dirs "/home/nasim_shafiee/catkin_ws_1/src/test/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'nasim_shafiee <nasim_shafiee@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nasim_shafiee/catkin_ws_1/src/test/${idir}'.  Ask the maintainer 'nasim_shafiee <nasim_shafiee@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nasim_shafiee/catkin_ws_1/devel/lib;/home/nasim_shafiee/catkin_ws_1/devel/lib;/opt/ros/indigo/lib)
...
set(test_EXPORTED_TARGETS "test_generate_messages_cpp;test_generate_messages_lisp;test_generate_messages_py")
